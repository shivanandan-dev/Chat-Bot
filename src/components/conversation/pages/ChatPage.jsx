...
export default function ChatPage() {
    ...
    const { data: messages, loading, error, setMessages, refetch } = useGetConversation(params.conversationId);
            ...
            <div className="flex-1 overflow-y-auto mb-4 space-y-4 p-4 border-0 rounded-lg no-scrollbar">
                {
                    error ? (
                        <div className="text-center">
                            <p className="text-rose-500 mb-2">Oops! Looks like the messages got lost in the void.</p>
